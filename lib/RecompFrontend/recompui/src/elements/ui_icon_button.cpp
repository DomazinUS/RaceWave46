...
namespace recompui {    
    IconButton::IconButton(ResourceId rid, Element *parent, const std::string &svg_src, ButtonStyle style, IconButtonSize size) : Element(rid, parent, Events(EventType::Click, EventType::Hover, EventType::Enable, EventType::Focus), "button") {
        ...
        svg->set_image_color(style == ButtonStyle::Basic ? theme::color::White : theme::color::TextDim);
        ...
        case EventType::Hover:
            {
                ...
                svg->set_image_color(style == ButtonStyle::Basic ? theme::color::White : (hover_active ? theme::color::Text : theme::color::TextDim));
            }
            break;
        ...
        case EventType::Focus:
            {
                ...
                svg->set_image_color(style == ButtonStyle::Basic ? theme::color::White : (focus_active ? theme::color::Text : theme::color::TextDim));
            }
            break;
    ...
    void IconButton::apply_theme_style(recompui::theme::color color, bool is_basic) {
        ...
        if (is_basic) {
            set_background_color(theme::color::White, 26);
            set_border_color(theme::color::White, 80);
            hover_style.set_background_color(theme::color::White, 55);
            focus_style.set_background_color(theme::color::Secondary);

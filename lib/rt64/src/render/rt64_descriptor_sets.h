...
namespace RT64 {
    ...
    struct FramebufferRendererDescriptorCommonSet : RenderDescriptorSetBase {
        ...
        uint32_t gBlueNoise;
        uint32_t wr64WaterAdjacency;
        uint32_t wr64FenceProxy;
        uint32_t wr64MotionDraws;
        uint32_t wr64SkyCapture;
        uint32_t wr64RasterSky;
        uint32_t wr64RasterShadowParams;
        uint32_t wr64RasterShadowMap;
        uint32_t wr64RasterReflectionParams;
        uint32_t wr64RasterReflectionColor;
        ...
        FramebufferRendererDescriptorCommonSet(const SamplerLibrary &samplerLibrary, bool raytracing, RenderDevice *device = nullptr) {
            ...
            wr64WaterAdjacency = builder.addByteAddressBuffer(68);
            wr64FenceProxy = builder.addByteAddressBuffer(69);
            wr64MotionDraws = builder.addStructuredBuffer(70);
            wr64SkyCapture = builder.addReadWriteByteAddressBuffer(71);
            wr64RasterSky = builder.addTexture(72);
            wr64RasterShadowParams = builder.addConstantBuffer(73);
            wr64RasterShadowMap = builder.addTexture(74);
            wr64RasterReflectionParams = builder.addConstantBuffer(75);
            wr64RasterReflectionColor = builder.addTexture(76);
            builder.end();
    ...
    struct RSPProcessDescriptorSet : RenderDescriptorSetBase {
        ...
        uint32_t dstTc;
        uint32_t dstCol;
        uint32_t wr64WaterFieldInfo;
        uint32_t wr64WaterFieldPrevPosShiftX;
        uint32_t wr64WaterFieldPrevTcShiftZ;
        uint32_t wr64WaterFieldFaceIndices;
        ...
        RSPProcessDescriptorSet(RenderDevice *device = nullptr) {
            ...
            wr64WaterFieldInfo = builder.addStructuredBuffer(22);
            wr64WaterFieldPrevPosShiftX = builder.addStructuredBuffer(23);
            wr64WaterFieldPrevTcShiftZ = builder.addStructuredBuffer(24);
            wr64WaterFieldFaceIndices = builder.addStructuredBuffer(25);
            builder.end();
    ...
    struct RSPWorldDescriptorSet : RenderDescriptorSetBase {
        ...
        RSPWorldDescriptorSet(RenderDevice *device = nullptr) {
            ...
            srcTc = builder.addFormattedBuffer(11);
            srcTcVel = builder.addFormattedBuffer(12);
            wr64WaterFieldInfo = builder.addStructuredBuffer(13);
            wr64WaterFieldPrevPosShiftX = builder.addStructuredBuffer(14);
            wr64WaterFieldPrevTcShiftZ = builder.addStructuredBuffer(15);
            wr64WaterFieldFaceIndices = builder.addStructuredBuffer(16);
            builder.end();

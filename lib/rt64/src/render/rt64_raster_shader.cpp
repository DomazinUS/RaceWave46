...
#   endif
        ...
        FramebufferRendererDescriptorCommonSet descriptorCommonSet(shaderLibrary->samplerLibrary,
            device->getCapabilities().raytracing || device->getCapabilities().rayQueries);

...
namespace RT64 {
    ...
    struct ReplacementMap {
        struct DolphinCache {
            ...
            std::unordered_map<uint64_t, ReplacementResolvedPath> resolvedPaths;
            std::unordered_set<uint64_t> missingHashes;
            std::unordered_map<std::string, ReplacementShift> pathShifts;
            bool enabled = false;
        };
        ...
        std::vector<DolphinCache> fileSystemDolphinCaches;

...
static int extract_id(const std::string& line) {
...
// Metal requires contiguous descriptor set buffer IDs.
// spirv-cross may generate non-contiguous IDs (e.g., 0, 2, 5).
// This function fills gaps with dummy padding resources.
static std::string pad_descriptor_sets(const std::string& source) {
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        // Map push constants to buffer(8) for all shader stages
        // This matches plume's PUSH_CONSTANTS_BINDING_INDEX

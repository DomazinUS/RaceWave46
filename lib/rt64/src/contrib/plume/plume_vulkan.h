...
namespace plume {
    ...
    struct VulkanGraphicsPipeline : VulkanPipeline {
        VkPipeline vk = VK_NULL_HANDLE;
        const char *diagnosticCheckpointPhase = nullptr;
    ...
    struct VulkanCommandList : RenderCommandList {
        ...
        const char *diagnosticCheckpointPhase = nullptr;
        const char *activeGraphicsCheckpointPhase = nullptr;
        ...
        void diagnosticCheckpoint(const char *phase);
    };
    ...
    struct VulkanDevice : RenderDevice {
        ...
        PFN_vkGetQueueCheckpointDataNV getQueueCheckpointData = nullptr;
        PFN_vkGetDeviceFaultInfoEXT getDeviceFaultInfo = nullptr;
        std::atomic<bool> checkpointFailureReported{false};
        ...
        void reportDeviceLossCheckpoints(const char *operation, uint32_t failingFamily, uint32_t failingQueue);
    };

    struct VulkanInterface : RenderInterface {
        VkInstance instance = VK_NULL_HANDLE;
        VkDebugUtilsMessengerEXT validationMessenger = VK_NULL_HANDLE;
        PFN_vkDestroyDebugUtilsMessengerEXT destroyValidationMessenger = nullptr;

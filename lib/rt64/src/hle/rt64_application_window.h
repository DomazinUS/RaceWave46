...
#       endif
        ...
        // SDL may invoke a filter synchronously while a window message is
        // serviced during graphics shutdown. Serialize listener access with
        // the transition that makes renderer-owned objects unavailable.
        std::recursive_mutex eventFilterMutex;
        bool eventFiltersStopped = false;

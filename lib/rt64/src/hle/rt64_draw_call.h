...
namespace RT64 {
    ...
    struct DrawCall {
        ...
        uint32_t uid;
        uint32_t callIndex;
        // Optional WR64 Composer provenance. These fields do not affect rendering.
        uint64_t wr64TaskSequence;
        uint32_t wr64TaskAddress;
        uint32_t wr64TaskContextRa;
        uint32_t wr64RootDisplayList;
        uint32_t wr64Ucode;
        uint32_t wr64UcodeData;
        Wr64HudMotion wr64HudMotion{};
        Wr64DolphinSunSprite wr64DolphinSunSprite{};
        uint32_t wr64DolphinSunVertexStart = Wr64DolphinSunNoVertices;

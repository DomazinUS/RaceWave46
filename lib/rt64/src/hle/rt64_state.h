...
namespace RT64 {
    ...
    struct State {
        std::vector<Wr64WaveDistancePacket> wr64WaveTaskPackets;
        struct External {
            Application *app;
...
#       endif
        ...
        uint64_t wr64CurrentTaskSequence;
        uint32_t wr64CurrentTaskAddress;
        uint32_t wr64CurrentTaskContextRa;
        uint32_t wr64CurrentRootDisplayList;
        uint32_t wr64CurrentUcode;
        uint32_t wr64CurrentUcodeData;
        Wr64HudMotion wr64HudCurrent{};
        Wr64DolphinSunSprite wr64DolphinSunCurrent{};
        ...
        Timestamp wr64CourseMapLastWorkloadTimestamp;
        bool wr64CourseMapLastTimestampValid = false;
        uint8_t wr64CourseMapCadenceHistory = 0;
        uint8_t wr64CourseMapCadenceSampleCount = 0;
        uint16_t wr64CourseMapMeasuredRate = 20;
